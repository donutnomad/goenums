...
// It returns the Version representation of the enum value if the string is valid
// Otherwise, it returns invalidVersion
...
// It returns the Version representation of the enum value if the numeric value is valid
// Otherwise, it returns invalidVersion
